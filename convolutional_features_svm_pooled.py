...
if __name__ == '__main__':
	X_train = dataset.read_convolutional_features(sys.argv[1], 'pooled', 'train')
	y_train = dataset.read_labels(sys.argv[1], 'train')
	X_validate = dataset.read_convolutional_features(sys.argv[1], 'pooled', 'validate')
	y_validate = dataset.read_labels(sys.argv[1], 'validate')
	X_test = dataset.read_convolutional_features(sys.argv[1], 'pooled', 'test')

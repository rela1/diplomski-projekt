...
Performansa modela koji prostorne značajke slika označenih konzistentno sa sustavom FTTS iRAP obrađuje povratnim LSTM ćelijama i dalje je niža od performanse modela na ručno označenim pojedinačnim slikama.
Pad performanse možemo analizirati tako da promotrimo sekvence slika iz podskupa za testiranje koje model loše klasificira. 

...
if __name__ == '__main__':
  ...
  convolutional_model = SequentialImageTemporalFCModelOnline(SEQUENCE_LENGTH, dataset, INPUT_SHAPE, SPATIAL_FULLY_CONNECTED, TEMPORAL_FULLY_CONNECTED, LEARNING_RATE, weight_decay=WEIGHT_DECAY, vgg_init_dir=vgg_init_dir, is_training=True)
